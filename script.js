...
function changeStudent(student){
    ...
    if(fName == '' || lName == ''){
        console.log("boucle");
        document.getElementById(`fName${student}`).style = "border: 3px solid red; visibility:visible;";
        document.getElementById(`lName${student}`).style = "border: 3px solid red; visibility:visible;";
    }
    else{
...
function createTable() {
    ...
    const lines = etudiants.map((e)=>`<tr id="e${e.id}">
                                        <td>
                                            ${e.id}
                                        </td>        
                                        <td>
                                            <div class="cell">
                                                ...
                                                <input class="input${e.id}" id="fName${e.id}" type="text" name="fName" placeholder="---enter first name"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="cell">
                                                <label for="fName" id="labelLName${e.id}">${e.lName}</label>
                                                <input class="input${e.id}" id="lName${e.id}" type="text" name="fName" placeholder="---enter last name"/>
                                            </div>
                                        </td>
                                        <td>
                                        <div class="cell_btn">
